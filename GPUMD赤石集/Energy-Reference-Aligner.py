...
output_xyz_file = 'test-output_aligned.xyz'
...
#  
ALIGNMENT_MODE = 'DFT_TO_NEP_ALIGNMENT' # 'REF_GROUP_ALIGNMENT', 'ZERO_BASELINE_ALIGNMENT', 'DFT_TO_NEP_ALIGNMENT'
...
nep_batch_size = 200 # Tune this value to balance memory usage and performance. The larger the batch value, the faster the speed, but the more memory is required
